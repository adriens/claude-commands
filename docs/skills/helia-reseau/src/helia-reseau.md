...
> **Distinction**
> - **Auteur du rapport** = Adrien SALES — toujours dans le footer (ne pas modifier)
> - **Propriétaire de la ligne** = alias libre sur la couverture — peut être un prénom,
>   un alias métier, un numéro de ligne (utile en contexte flotte d'entreprise)
